...
class RecordShare extends BaseEntity
{
    ...
    {
        return $this->belongsTo(IdentityUser::class, 'shared_with_user_id', 'record_id');
    }
    ...
    {
        return $this->belongsTo(IdentityUser::class, 'shared_by', 'record_id');
    }
     ...
     */
    public function canUserAccess(IdentityUser $user, string $action): bool
    {
